...
> NOTE: This really wants to be a name server rather than modifying `/etc/hosts` so other it works with other VMs on a machine. It might be that one day but for now its not going to be :(
